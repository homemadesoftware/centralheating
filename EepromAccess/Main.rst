   ...
   0000                     216 	.org 0x0000
                    ...
                    008F    246 _CKCON0	=	0x008f
                    00AF    247 _CKCON1	=	0x00af
   ...
   0000                     293 	.org 0x0000
                    ...
                    00E8    410 _P5_0	=	0x00e8
                    00E9    411 _P5_1	=	0x00e9
                    00EA    412 _P5_2	=	0x00ea
                    00EB    413 _P5_3	=	0x00eb
                    00EC    414 _P5_4	=	0x00ec
                    00ED    415 _P5_5	=	0x00ed
                    00EE    416 _P5_6	=	0x00ee
                    00EF    417 _P5_7	=	0x00ef
                            418 ;--------------------------------------------------------
   ...
   001B                     434 _WriteByte_PARM_2::
   001B                     435 	.ds 1
                            436 ;--------------------------------------------------------
                            437 ; Stack segment in internal ram 
                            438 ;--------------------------------------------------------
                            439 	.area	SSEG	(DATA)
   001E                     440 __start__stack:
   001E                     441 	.ds	1
                            442 
                            443 ;--------------------------------------------------------
                            ...
                            481 	.area CSEG    (CODE)
                            482 ;--------------------------------------------------------
                            483 ; interrupt vector 
                            484 ;--------------------------------------------------------
                            485 	.area HOME    (CODE)
   0000                     486 __interrupt_vect:
   0000 02 00 08            487 	ljmp	__sdcc_gsinit_startup
                            488 ;--------------------------------------------------------
   ...
   0061 02 00 03            502 	ljmp	__sdcc_program_startup
                            503 ;--------------------------------------------------------
                            504 ; Home
                            505 ;--------------------------------------------------------
                            506 	.area HOME    (CODE)
                            507 	.area HOME    (CODE)
   0003                     508 __sdcc_program_startup:
   0003 12 00 AB            509 	lcall	_main
                            510 ;	return from main will lock up
   0006 80 FE               511 	sjmp .
                            512 ;--------------------------------------------------------
                            513 ; code
                            514 ;--------------------------------------------------------
                            515 	.area CSEG    (CODE)
                            516 ;------------------------------------------------------------
                            517 ;Allocation info for local variables in function 'ReadByte'
                            518 ;------------------------------------------------------------
                            519 ;address                   Allocated to registers r2 r3 
                            520 ;value                     Allocated to registers r2 
                            521 ;eaSave                    Allocated to registers r4 
                            522 ;------------------------------------------------------------
                            523 ;	Main.c:5: unsigned char ReadByte(int address)
                            524 ;	-----------------------------------------
                            525 ;	 function ReadByte
                            526 ;	-----------------------------------------
   0064                     527 _ReadByte:
                    0002    528 	ar2 = 0x02
                    0003    529 	ar3 = 0x03
                    ...
                    0000    534 	ar0 = 0x00
                    0001    535 	ar1 = 0x01
   0064 AA 82               536 	mov	r2,dpl
   0066 AB 83               537 	mov	r3,dph
                            538 ;	Main.c:11: while (EECON & EEBUSY > 0)
   0068                     539 00101$:
   0068 E5 D2               540 	mov	a,_EECON
   006A 20 E0 FB            541 	jb	acc.0,00101$
                            542 ;	Main.c:16: eaSave = EA;
   006D A2 AF               543 	mov	c,_EA
   006F E4                  544 	clr	a
   0070 33                  545 	rlc	a
   0071 FC                  546 	mov	r4,a
                            547 ;	Main.c:17: EA = 0;
   0072 C2 AF               548 	clr	_EA
                            549 ;	Main.c:20: EECON |= EEE;
   0074 43 D2 02            550 	orl	_EECON,#0x02
                            551 ;	Main.c:23: value = *(unsigned char __xdata*)address;
   0077 8A 82               552 	mov	dpl,r2
   0079 8B 83               553 	mov	dph,r3
   007B E0                  554 	movx	a,@dptr
   007C FA                  555 	mov	r2,a
                            556 ;	Main.c:26: EECON &= ~EEE;
   007D 53 D2 FD            557 	anl	_EECON,#0xFD
                            558 ;	Main.c:29: EA = eaSave;
   0080 EC                  559 	mov	a,r4
   0081 24 FF               560 	add	a,#0xff
   0083 92 AF               561 	mov	_EA,c
                            562 ;	Main.c:31: return value;
   0085 8A 82               563 	mov	dpl,r2
   0087 22                  564 	ret
                            565 ;------------------------------------------------------------
                            566 ;Allocation info for local variables in function 'WriteByte'
                            567 ;------------------------------------------------------------
                            568 ;value                     Allocated with name '_WriteByte_PARM_2'
                            569 ;address                   Allocated to registers r2 r3 
                            570 ;eaSave                    Allocated to registers r4 
                            571 ;------------------------------------------------------------
                            572 ;	Main.c:34: void WriteByte(int address, unsigned char value)
                            573 ;	-----------------------------------------
                            574 ;	 function WriteByte
                            575 ;	-----------------------------------------
   0088                     576 _WriteByte:
   0088 AA 82               577 	mov	r2,dpl
   008A AB 83               578 	mov	r3,dph
                            579 ;	Main.c:39: while (EECON & EEBUSY > 0)
   008C                     580 00101$:
   008C E5 D2               581 	mov	a,_EECON
   008E 20 E0 FB            582 	jb	acc.0,00101$
                            583 ;	Main.c:44: eaSave = EA;
   0091 A2 AF               584 	mov	c,_EA
   0093 E4                  585 	clr	a
   0094 33                  586 	rlc	a
   0095 FC                  587 	mov	r4,a
                            588 ;	Main.c:45: EA = 0;
   0096 C2 AF               589 	clr	_EA
                            590 ;	Main.c:48: EECON |= EEE;
   0098 43 D2 02            591 	orl	_EECON,#0x02
                            592 ;	Main.c:51: *(unsigned char __xdata*)address = value;
   009B 8A 82               593 	mov	dpl,r2
   009D 8B 83               594 	mov	dph,r3
   009F E5 1B               595 	mov	a,_WriteByte_PARM_2
   00A1 F0                  596 	movx	@dptr,a
                            597 ;	Main.c:54: EECON &= ~EEE;
   00A2 53 D2 FD            598 	anl	_EECON,#0xFD
                            599 ;	Main.c:57: EA = eaSave;
   00A5 EC                  600 	mov	a,r4
   00A6 24 FF               601 	add	a,#0xff
   00A8 92 AF               602 	mov	_EA,c
   00AA 22                  603 	ret
                            604 ;------------------------------------------------------------
                            605 ;Allocation info for local variables in function 'main'
                            606 ;------------------------------------------------------------
                            607 ;c1                        Allocated to registers r2 
                            608 ;c2                        Allocated to registers 
                            609 ;buf                       Allocated with name '_main_buf_1_1'
                            610 ;------------------------------------------------------------
                            611 ;	Main.c:61: void main(void)
                            612 ;	-----------------------------------------
                            613 ;	 function main
                            614 ;	-----------------------------------------
   00AB                     615 _main:
                            616 ;	Main.c:67: CKCON0 = 0x01;						// Initial X2 Mode (BUS Clock = 58.9824 MHz) 
   00AB 75 8F 01            617 	mov	_CKCON0,#0x01
                            618 ;	Main.c:68: InitialiseLcd();
   00AE 12 00 F7            619 	lcall	_InitialiseLcd
                            620 ;	Main.c:70: for (c1 = 'A'; c1 <= 'Z'; ++c1)
   00B1 7A 41               621 	mov	r2,#0x41
   00B3                     622 00101$:
   00B3 C3                  623 	clr	c
   00B4 74 DA               624 	mov	a,#(0x5A ^ 0x80)
   00B6 8A F0               625 	mov	b,r2
   00B8 63 F0 80            626 	xrl	b,#0x80
   00BB 95 F0               627 	subb	a,b
   00BD 40 37               628 	jc	00105$
                            629 ;	Main.c:72: DirectWriteToDisplay("           ");
   00BF 90 04 CC            630 	mov	dptr,#__str_0
   00C2 75 F0 80            631 	mov	b,#0x80
   00C5 C0 02               632 	push	ar2
   00C7 12 02 0C            633 	lcall	_DirectWriteToDisplay
   00CA D0 02               634 	pop	ar2
                            635 ;	Main.c:74: WriteByte(0, c1);
   00CC 8A 1B               636 	mov	_WriteByte_PARM_2,r2
   00CE 90 00 00            637 	mov	dptr,#0x0000
   00D1 C0 02               638 	push	ar2
   00D3 12 00 88            639 	lcall	_WriteByte
                            640 ;	Main.c:76: c2 = ReadByte(0);
   00D6 90 00 00            641 	mov	dptr,#0x0000
   00D9 12 00 64            642 	lcall	_ReadByte
   00DC 85 82 17            643 	mov	_UnsignedCharToString_PARM_2,dpl
                            644 ;	Main.c:78: UnsignedCharToString(buf, c2);
   00DF 90 00 08            645 	mov	dptr,#_main_buf_1_1
   00E2 75 F0 40            646 	mov	b,#0x40
   00E5 12 03 53            647 	lcall	_UnsignedCharToString
                            648 ;	Main.c:79: DirectWriteToDisplay(buf);
   00E8 90 00 08            649 	mov	dptr,#_main_buf_1_1
   00EB 75 F0 40            650 	mov	b,#0x40
   00EE 12 02 0C            651 	lcall	_DirectWriteToDisplay
   00F1 D0 02               652 	pop	ar2
                            653 ;	Main.c:70: for (c1 = 'A'; c1 <= 'Z'; ++c1)
   00F3 0A                  654 	inc	r2
   00F4 80 BD               655 	sjmp	00101$
   00F6                     656 00105$:
   00F6 22                  657 	ret
                            658 	.area CSEG    (CODE)
                            659 	.area CONST   (CODE)
   04CC                     660 __str_0:
   04CC 20 20 20 20 20 20   661 	.ascii "           "
        20 20 20 20 20
   04D7 00                  662 	.db 0x00
                            663 	.area XINIT   (CODE)
