...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'BuildCentralHeatingMenuDefinitions'
;------------------------------------------------------------
;	../Common/CentralHeatingMenus.c:9: void BuildCentralHeatingMenuDefinitions()
;	-----------------------------------------
;	 function BuildCentralHeatingMenuDefinitions
;	-----------------------------------------
_BuildCentralHeatingMenuDefinitions:
	ar7 = 0x07
	ar6 = 0x06
	ar5 = 0x05
	ar4 = 0x04
	...
	ar1 = 0x01
	ar0 = 0x00
;	../Common/CentralHeatingMenus.c:12: InitialiseMenuDefinitions();
	lcall	_InitialiseMenuDefinitions
;	../Common/CentralHeatingMenus.c:14: AddMenuDefinition("Hot Water", 0, MENUID_HOTWATER);
